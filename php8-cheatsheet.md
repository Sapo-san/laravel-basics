# php8 Syntax Cheatsheet

Original: [PHP cheat sheet (updated to PHP 8.1)](https://dev.to/ericchapman/php-cheat-sheet-updated-to-php-81-3o4p)

Some edits/additions made by me.

Made this Cheatsheet because the one at [learnXinYminutes.com](https://learnxinyminutes.com/docs/php/) was kinda outdated.

## Cheatsheet

### php local server
```bash
php <filename.php> -S localhost:3000
```
...
*/
```
All php code must start with `<?php` and end with `?>`
```php
<?php
/*
    blah blah
*/
?> // If not closed, the rest of the file is php by default
```

### Naming Conventions:
```php
// Note: All lines of code must end with ;
...
/*
    Namespace
    TL;DR Code encapsulation, avoids name collision between libraries
...
echo "Hello world yet again mk2\n";
